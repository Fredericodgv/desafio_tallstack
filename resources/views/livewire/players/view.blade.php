                ...
                <div class="p-6 space-y-6 flex items-center">
                    ...
                    <form wire:submit.prevent="submit" class="space-y-8 divide-y divide-gray-200">
                        <div class="col-span-3">
                            ...
                            <input type="text" disabled id="name" autocomplete="name" wire:model="name">
                            @error('name')
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number" disabled id="age" autocomplete="age" wire:model="age">
                            @error('age')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="text" disabled id="team" wire:model="team">
                            @error('team')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="text" disabled id="nacionality" wire:model="nacionality">
                            @error('nacionality')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="number" disabled id="victories" wire:model="victories">
                            @error('victories')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="number" disabled id="defeats" wire:model="defeats">
                            @error('defeats')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
